...
xtreg pct_dv_article pct_by_bots pct_contain_template time_index cv_wp_tenure ls_cv_project_scope ls_cv_active_members ls_cv_pre_edits 
xtreg pct_dv_article_bot pct_by_bots pct_contain_template time_index cv_wp_tenure ls_cv_project_scope ls_cv_active_members ls_cv_pre_edits 
xtreg pct_dv_article_human pct_by_bots pct_contain_template time_index cv_wp_tenure ls_cv_project_scope ls_cv_active_members ls_cv_pre_edits 
...
xtreg pct_dv_article_bot pct_template_bots pct_by_bots pct_contain_template time_index cv_wp_tenure ls_cv_project_scope ls_cv_active_members ls_cv_pre_edits 
xtreg pct_dv_article_human pct_template_bots pct_by_bots pct_contain_template time_index cv_wp_tenure ls_cv_project_scope ls_cv_active_members ls_cv_pre_edits 
...
xtreg pct_dv_article_human pct_article_bot pct_member_bot pct_project_bot time_index cv_wp_tenure ls_cv_project_scope ls_cv_active_members ls_cv_pre_edits ls_cv_article_bot ls_cv_member_bot ls_cv_project_bot 
xtreg pct_dv_article_bot pct_article_bot pct_member_bot pct_project_bot time_index cv_wp_tenure ls_cv_project_scope ls_cv_active_members ls_cv_pre_edits ls_cv_article_bot ls_cv_member_bot ls_cv_project_bot 
...
xtreg pct_dv_article_human pct_template_article pct_template_member pct_template_project time_index cv_wp_tenure ls_cv_project_scope ls_cv_active_members ls_cv_pre_edits ls_cv_article_template ls_cv_member_template ls_cv_project_template 
xtreg pct_dv_article_bot pct_template_article pct_template_member pct_template_project time_index cv_wp_tenure ls_cv_project_scope ls_cv_active_members ls_cv_pre_edits ls_cv_article_template ls_cv_member_template ls_cv_project_template 
